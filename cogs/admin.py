...
class Admin(commands.Cog):
    ...
    async def kick(self, interaction: discord.Interaction, membres: discord.Member, raison: str = "Aucune raison fournie"):
    ...
    async def ban(self, interaction: discord.Interaction, membres: discord.Member, raison: str = "Aucune raison fournie"):
